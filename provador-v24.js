(function () {
    ...
    const html = `
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=carminito" target="_blank" rel="dofollow noopener" class="q-powered-footer" style="text-decoration:none;">
    ...
    function init() {
        ...
        // Coloca o selo dentro do product-gallery (container estavel que nao re-renderiza)
